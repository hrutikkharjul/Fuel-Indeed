...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <div class="form-control">
      <h4>Available Fuel = <%= rs.getString("fuel_available") %><h4>
    </div>
 <%
 		}
	} catch(Exception e) {
 ...
 %>  
    ...
    <div class="row mt-3">
      <div class="col-lg-6">
        <div class="card">
           <div class="card-body">
           <div class="card-title">Update Fuel</div>
           <hr>
            <form action="PPFuelUpdate" method="post">
           <div class="form-group">
            <label for="input-6">Enter Fuel Available</label>
            <input type="text" class="form-control form-control-rounded" id="input-6" placeholder="Enter Fuel Available" name="fuel">
           </div>
           <br>
           <div class="form-group">
            <button type="submit" class="btn btn-light btn-round px-5">Update Fuel Available </button>
          </div>
          </form>
         </div>
         </div>
