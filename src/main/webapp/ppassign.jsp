 ...
 <div id="wrapper">
  ...
  <ul class="sidebar-menu do-nicescrol">
     ...
     <li>
      ...
      <li>
       <a href="pplogin.html" target="_blank">
...
<!--End Row-->
        <div class="col-lg-15">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Assign Bookings to an Employee</h5>
...
%>	
	  	<tr>
     		...
     		<td><a href="ppassignbooking.jsp?eid=<%= rs.getInt("id")%>&bid=<%= bid%>">Select</a></td>
     	</tr>
<%
		}
	} catch(Exception e) {
